...
const dtFloat = new FixedType<number>('decimal', '#00cc99', v => parseFloat(v), dtString, () => -1, new RegExp('^[0-9]+(\.[0-9]*)?$'), 'A positive decimal value');
const dtInt = new FixedType<number>('integer', '#0099ff', v => parseInt(v), dtFloat, () => -1, new RegExp('^[0-9]+$'), 'A positive integer value');
